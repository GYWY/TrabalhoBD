    ...
    public AlunoAlterar() {
        ...
        btAlterar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Aluno novoAluno = (Aluno) alunoDAO.buscarId((Long) tableListaAlunos.getValueAt(opAluno, 0));
                if(!nome.equals(""))
                    novoAluno.setNome(nome);
                if(!cpf.equals(""))
                    novoAluno.setCpf(cpf);
                
                alunoDAO.alterar(novoAluno);
                JOptionPane.showMessageDialog(new JFrame(), "Aluno alterado com sucesso.", "Alterado", JOptionPane.DEFAULT_OPTION);
            }
        });
